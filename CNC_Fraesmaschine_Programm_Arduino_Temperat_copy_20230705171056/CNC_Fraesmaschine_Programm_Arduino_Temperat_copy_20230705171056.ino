...
int Sensor_Pin = A0;
#define Referenzwiderstand   55300 // Widerstandswert des Widerstandes der mit dem NTC in Reihe geschaltet wurde.
#define Nominalwiderstand    50000 // Widerstand des NTC bei Normaltemperatur
